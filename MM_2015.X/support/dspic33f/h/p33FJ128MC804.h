...
extern volatile unsigned int  DAC1STAT __attribute__((__sfr__));
...
extern volatile unsigned int  DAC1DFLT __attribute__((__sfr__));
#define DAC1RDAT DAC1RDAT
extern volatile unsigned int  DAC1RDAT __attribute__((__sfr__));
#define DAC1LDAT DAC1LDAT
extern volatile unsigned int  DAC1LDAT __attribute__((__sfr__));
