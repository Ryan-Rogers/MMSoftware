/*-------------------------------------------------------------------------
 * MPLAB-Cxx  dsPIC33FJ16GS402 processor header
 *
 * (c) Copyright 1999-2014 Microchip Technology, All rights reserved
 * Part support version v1.22.A(19-Aug-2014)
 *-------------------------------------------------------------------------*/

#ifndef __dsPIC33FJ16GS402__
#error "Include file does not match processor setting"
#endif

#ifndef __33FJ16GS402_H
#define __33FJ16GS402_H
...
#define _FLTMOD0 FCLCON1bits.FLTMOD0
#define _FLTMOD1 FCLCON1bits.FLTMOD1
