/*-------------------------------------------------------------------------
 * MPLAB-Cxx  PIC24F04KA200 processor header
 *
 * (c) Copyright 1999-2014 Microchip Technology, All rights reserved
 * Part support version v1.22.A(19-Aug-2014)
 *-------------------------------------------------------------------------*/

#ifndef __PIC24F04KA200__
#error "Include file does not match processor setting"
#endif

#ifndef __24F04KA200_H
#define __24F04KA200_H
...
**     OSCIOFNC_ON          CLKO output disabled
**     OSCIOFNC_OFF         CLKO output signal active on the OSCO pin; primary oscillator must be disabled or configured for the External Clock mode (EC) for the CLKO to be active (POSCMD<1:0>)
**
...
**     FCKSM_CSDCMD         Clock switching is disabled, Fail-Safe Clock Monitor is disabled
**
*/
...
**     BORV_27V             Brown-out Reset set to highest voltage (2.7V)
**     BORV_20V             Brown-out Reset set to 2.0V
**     BORV_18V             Brown-out Reset set to lowest voltage (1.8V)
**
**   MCLR Pin Enable bit:
...
**
**   Reserved:
**     ICS_PGx3             PGC3/PGD3 are used for programming the device
**     ICS_PGx2             PGC2/PGD2 are used for programming the device
**
*/
...
**     DSLPBOR_OFF          Deep Sleep BOR disabled in Deep Sleep
**     DSLPBOR_ON           Deep Sleep BOR enabled in Deep Sleep
**
