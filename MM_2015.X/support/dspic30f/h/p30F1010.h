/*-------------------------------------------------------------------------
 * MPLAB-Cxx  dsPIC30F1010 processor header
 *
 * (c) Copyright 1999-2014 Microchip Technology, All rights reserved
 * Part support version v1.22.A(19-Aug-2014)
 *-------------------------------------------------------------------------*/

#ifndef __dsPIC30F1010__
...
typedef struct tagACCAUBITS {
  unsigned ACCAU:8;
  unsigned SIGNEXT:8;
} ACCAUBITS;
extern volatile ACCAUBITS ACCAUbits __attribute__((__sfr__));
...
typedef struct tagACCBUBITS {
  unsigned ACCBU:8;
  unsigned SIGNEXT:8;
} ACCBUBITS;
extern volatile ACCBUBITS ACCBUbits __attribute__((__sfr__));
...
extern volatile PCHBITS PCHbits __attribute__((__sfr__));
...
extern volatile DCOUNTBITS DCOUNTbits __attribute__((__sfr__));
...
extern volatile DOSTARTHBITS DOSTARTHbits __attribute__((__sfr__));
...
extern volatile DOENDHBITS DOENDHbits __attribute__((__sfr__));
...
__extension__ typedef struct tagADPCFGBITS {
  union {
    struct {
      unsigned PCFG:8;
    };
...
__extension__ typedef struct tagADSTATBITS {
  union {
    struct {
      unsigned PxRDY:3;
    };
...
/* ACCAU */
#define _ACCAU ACCAUbits.ACCAU
/* Bitname _SIGNEXT cannot be defined because it is used by more than one SFR */

/* ACCBU */
#define _ACCBU ACCBUbits.ACCBU
/* Bitname _SIGNEXT cannot be defined because it is used by more than one SFR */

/* PCH */
#define _PCH PCHbits.PCH

/* RCOUNT */
#define _RCOUNT RCOUNTbits.RCOUNT

/* DCOUNT */
#define _DCOUNT DCOUNTbits.DCOUNT

/* DOSTARTH */
#define _DOSTARTH DOSTARTHbits.DOSTARTH

/* DOENDH */
#define _DOENDH DOENDHbits.DOENDH
...
/* ADSTAT */
#define _PxRDY ADSTATbits.PxRDY
...
#define _TRGSRC15 ADCPC0bits.TRGSRC15
...
#define _ACCAU_ACCAU_POSITION                    0x00000000
#define _ACCAU_ACCAU_MASK                        0x000000FF
#define _ACCAU_ACCAU_LENGTH                      0x00000008

#define _ACCAU_SIGNEXT_POSITION                  0x00000008
#define _ACCAU_SIGNEXT_MASK                      0x0000FF00
#define _ACCAU_SIGNEXT_LENGTH                    0x00000008

#define _ACCBU_ACCBU_POSITION                    0x00000000
#define _ACCBU_ACCBU_MASK                        0x000000FF
#define _ACCBU_ACCBU_LENGTH                      0x00000008

#define _ACCBU_SIGNEXT_POSITION                  0x00000008
#define _ACCBU_SIGNEXT_MASK                      0x0000FF00
#define _ACCBU_SIGNEXT_LENGTH                    0x00000008

#define _PCH_PCH_POSITION                        0x00000000
#define _PCH_PCH_MASK                            0x0000007F
#define _PCH_PCH_LENGTH                          0x00000007

#define _RCOUNT_RCOUNT_POSITION                  0x00000000
#define _RCOUNT_RCOUNT_MASK                      0x00003FFF
#define _RCOUNT_RCOUNT_LENGTH                    0x0000000E

#define _DCOUNT_DCOUNT_POSITION                  0x00000000
#define _DCOUNT_DCOUNT_MASK                      0x00003FFF
#define _DCOUNT_DCOUNT_LENGTH                    0x0000000E

#define _DOSTARTH_DOSTARTH_POSITION              0x00000000
#define _DOSTARTH_DOSTARTH_MASK                  0x0000007F
#define _DOSTARTH_DOSTARTH_LENGTH                0x00000007

#define _DOENDH_DOENDH_POSITION                  0x00000000
#define _DOENDH_DOENDH_MASK                      0x0000007F
#define _DOENDH_DOENDH_LENGTH                    0x00000007
...
#define _ADPCFG_PCFG_POSITION                    0x00000000
#define _ADPCFG_PCFG_MASK                        0x000000FF
#define _ADPCFG_PCFG_LENGTH                      0x00000008
...
#define _ADSTAT_PxRDY_POSITION                   0x00000000
#define _ADSTAT_PxRDY_MASK                       0x00000007
#define _ADSTAT_PxRDY_LENGTH                     0x00000003
...
#define _ADCPC0_TRGSRC15_POSITION                0x0000000D
#define _ADCPC0_TRGSRC15_MASK                    0x00002000
#define _ADCPC0_TRGSRC15_LENGTH                  0x00000001
...
#define _TRIG1_TRIG1_POSITION                    0x00000000
#define _TRIG1_TRIG1_MASK                        0x0000FFFF
#define _TRIG1_TRIG1_LENGTH                      0x00000010
...
#define _TRIG2_TRIG2_POSITION                    0x00000000
#define _TRIG2_TRIG2_MASK                        0x0000FFFF
#define _TRIG2_TRIG2_LENGTH                      0x00000010
