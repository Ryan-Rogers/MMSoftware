/*-------------------------------------------------------------------------
 * MPLAB-Cxx  dsPIC30F6010 processor header
 *
 * (c) Copyright 1999-2014 Microchip Technology, All rights reserved
 * Part support version v1.22.A(19-Aug-2014)
 *-------------------------------------------------------------------------*/

#ifndef __dsPIC30F6010__
...
**
**   Oscillator Source:
**     LOPOSC               Low-Power 32KHz Osc <TMR1 Osc>
...
**     PWMxL_ACT_LOW        Active Low
**     PWMxL_ACT_HIGH       Active High
**
**   High-side PWM Output Polarity:
**     PWMxH_ACT_LOW        Active Low
**     PWMxH_ACT_HIGH       Active High
**
...
#define PWMxL_ACT_LOW        0xFEFF
#define PWMxL_ACT_HIGH       0xFFFF

#define PWMxH_ACT_LOW        0xFDFF
#define PWMxH_ACT_HIGH       0xFFFF
