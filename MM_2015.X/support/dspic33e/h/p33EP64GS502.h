/*-------------------------------------------------------------------------
 * MPLAB-Cxx  dsPIC33EP64GS502 processor header
 *
 * (c) Copyright 1999-2014 Microchip Technology, All rights reserved
 * Part support version v1.22.A(19-Aug-2014)
 *-------------------------------------------------------------------------*/

#ifndef __dsPIC33EP64GS502__
#error "Include file does not match processor setting"
#endif

#ifndef __33EP64GS502_H
#define __33EP64GS502_H
...
#define _TRGSRC10 ADTRIG1bits.TRGSRC10
#define _TRGSRC11 ADTRIG1bits.TRGSRC11
#define _TRGSRC12 ADTRIG1bits.TRGSRC12
#define _TRGSRC13 ADTRIG1bits.TRGSRC13
#define _TRGSRC14 ADTRIG1bits.TRGSRC14
...
#define _TRGSRC22 ADTRIG2bits.TRGSRC22
#define _TRGSRC23 ADTRIG2bits.TRGSRC23
#define _TRGSRC24 ADTRIG2bits.TRGSRC24
...
/* Register FBOOT (0x801000)                               */

extern __attribute__((space(prog))) unsigned int _FBOOT;
#define _FBOOT(x) __attribute__((section("__FBOOT.sec"),space(prog))) unsigned int _FBOOT = (x);
...
**     BTMODE_DUALPRIV      Device is in Dual Boot Privilege mode
**     BTMODE_DUALPROT      Device is in Dual Boot Protected mode
**     BTMODE_DUAL          Device is in Dual Boot mode
**     BTMODE_SINGLE        Device is in Single Boot (legacy) mode
**
*/

#define BTMODE_DUALPRIV      0xFFFC
#define BTMODE_DUALPROT      0xFFFD
#define BTMODE_DUAL          0xFFFE
#define BTMODE_SINGLE        0xFFFF

/* Fuses that are only present in single panel mode */

#ifndef __DUAL_PARTITION
/* Register FSEC (0xaf80)                               */
...
/* Register FBTSEQ (0xaffc)                               */

extern __attribute__((space(prog))) unsigned int _FBTSEQ;
#define _FBTSEQ(x) __attribute__((section("__FBTSEQ.sec"),space(prog))) unsigned int _FBTSEQ = (x);
...
#define __FSEC_BASE 0xaf80
#define __FSEC_LENGTH 0x2

#define __FBSLIM_BASE 0xaf90
#define __FBSLIM_LENGTH 0x2

#define __FSIGN_BASE 0xaf94
#define __FSIGN_LENGTH 0x2

#define __FOSCSEL_BASE 0xaf98
#define __FOSCSEL_LENGTH 0x2

#define __FOSC_BASE 0xaf9c
#define __FOSC_LENGTH 0x2

#define __FWDT_BASE 0xafa0
#define __FWDT_LENGTH 0x2

#define __FPOR_BASE 0xafa4
#define __FPOR_LENGTH 0x2

#define __FICD_BASE 0xafa8
#define __FICD_LENGTH 0x2

#define __FDEVOPT_BASE 0xafac
#define __FDEVOPT_LENGTH 0x2

#define __FALTREG_BASE 0xafb0
#define __FALTREG_LENGTH 0x2

#define __FBTSEQ_BASE 0xaffc
