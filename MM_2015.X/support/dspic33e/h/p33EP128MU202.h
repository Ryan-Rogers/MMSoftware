/*-------------------------------------------------------------------------
 * MPLAB-Cxx  dsPIC33EP128MU202 processor header
 *
 * (c) Copyright 1999-2014 Microchip Technology, All rights reserved
 * Part support version v1.22.A(19-Aug-2014)
 *-------------------------------------------------------------------------*/

#ifndef __dsPIC33EP128MU202__
#error "Include file does not match processor setting"
#endif

#ifndef __33EP128MU202_H
#define __33EP128MU202_H
...
#define __PROGRAM_LENGTH 0x153ec

#define __FICD_BASE 0x155f0
#define __FICD_LENGTH 0x2

#define __FPOR_BASE 0x155f2
#define __FPOR_LENGTH 0x2

#define __FWDT_BASE 0x155f4
#define __FWDT_LENGTH 0x2

#define __FOSC_BASE 0x155f6
#define __FOSC_LENGTH 0x2

#define __FOSCSEL_BASE 0x155f8
#define __FOSCSEL_LENGTH 0x2

#define __FGS_BASE 0x155fa
