/*-------------------------------------------------------------------------
 * MPLAB-Cxx  dsPIC33EP64MU204 processor header
 *
 * (c) Copyright 1999-2014 Microchip Technology, All rights reserved
 * Part support version v1.22.A(19-Aug-2014)
 *-------------------------------------------------------------------------*/

#ifndef __dsPIC33EP64MU204__
#error "Include file does not match processor setting"
#endif

#ifndef __33EP64MU204_H
#define __33EP64MU204_H
...
#define __PROGRAM_LENGTH 0xa8ec

#define __FICD_BASE 0xaaf0
#define __FICD_LENGTH 0x2

#define __FPOR_BASE 0xaaf2
#define __FPOR_LENGTH 0x2

#define __FWDT_BASE 0xaaf4
#define __FWDT_LENGTH 0x2

#define __FOSC_BASE 0xaaf6
#define __FOSC_LENGTH 0x2

#define __FOSCSEL_BASE 0xaaf8
#define __FOSCSEL_LENGTH 0x2

#define __FGS_BASE 0xaafa
