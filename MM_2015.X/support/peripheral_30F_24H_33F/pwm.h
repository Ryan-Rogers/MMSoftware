...
#define EnableIntMCPWM                    _PWMIE = 1
#define DisableIntMCPWM                   _PWMIE = 0
#define SetPriorityIntMCPWM(priority)     _PWMIP = priority

#define EnableIntFLTA                     _FLTAIE = 1
#define DisableIntFLTA                    _FLTAIE = 0
#define SetPriorityIntFLTA(priority)      _FLTAIP = priority
